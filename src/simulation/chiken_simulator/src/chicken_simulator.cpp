...
ChickenSimulator::ChickenSimulator(const rclcpp::NodeOptions & node_options)
: Node("chicken_simulator", node_options)
{
  ...
  twist_subscriber_ = create_subscription<geometry_msgs::msg::Twist>(
    "cmd_vel", 10, std::bind(&ChickenSimulator::callback_cmd_vel, this, std::placeholders::_1));
  
  // initial_pose_subscriber_ = create_subscription<geometry_msgs::msg::PoseWithCovarianceStamped>(
  //   "initial_pose", 10, std::bind(&ChickenSimulator::callback_initial_pose, this, std::placeholders::_1));
  ...
  timer_ = create_wall_timer(
    ...
    std::bind(&ChickenSimulator::update, this));
}

void ChickenSimulator::callback_cmd_vel(const geometry_msgs::msg::Twist & msg)
{
  cmd_vel_msg_ = msg;
}

void ChickenSimulator::callback_initial_pose(
