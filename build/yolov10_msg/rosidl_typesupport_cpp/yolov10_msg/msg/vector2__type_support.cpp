...
static const _Vector2_type_support_symbol_names_t _Vector2_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, yolov10_msg, msg, Vector2)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, yolov10_msg, msg, Vector2)),
  }
};
...
{
  return &::yolov10_msg::msg::rosidl_typesupport_cpp::Vector2_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, yolov10_msg, msg, Vector2)() {
  return get_message_type_support_handle<yolov10_msg::msg::Vector2>();
}
