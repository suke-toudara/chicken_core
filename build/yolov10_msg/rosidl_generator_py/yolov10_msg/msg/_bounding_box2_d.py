...
class BoundingBox2D(metaclass=Metaclass_BoundingBox2D):
    ...
    _fields_and_field_types = {
        'center': 'yolov10_msg/Pose2D',
        'size': 'yolov10_msg/Vector2',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['yolov10_msg', 'msg'], 'Pose2D'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['yolov10_msg', 'msg'], 'Vector2'),  # noqa: E501
    )
