...
class Metaclass_KeyPoint3DArray(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from yolov10_msg.msg import KeyPoint3D
...
class KeyPoint3DArray(metaclass=Metaclass_KeyPoint3DArray):
    ...
    _fields_and_field_types = {
        'data': 'sequence<yolov10_msg/KeyPoint3D>',
        'frame_id': 'string',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['yolov10_msg', 'msg'], 'KeyPoint3D')),  # noqa: E501
