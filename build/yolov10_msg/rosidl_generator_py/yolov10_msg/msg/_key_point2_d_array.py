...
class KeyPoint2DArray(metaclass=Metaclass_KeyPoint2DArray):
    ...
    _fields_and_field_types = {
        'data': 'sequence<yolov10_msg/KeyPoint2D>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['yolov10_msg', 'msg'], 'KeyPoint2D')),  # noqa: E501
    )
