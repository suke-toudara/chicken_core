...
#include "yolov10_msg/msg/detail/bounding_box3_d__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const yolov10_msg::msg::BoundingBox3D & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  yolov10_msg::msg::BoundingBox3D & ros_message)
{
  // Member: center
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = yolov10_msg::msg::BoundingBox3D;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const yolov10_msg::msg::BoundingBox3D *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<yolov10_msg::msg::BoundingBox3D *>(
    untyped_ros_message);
...
{
  return &yolov10_msg::msg::typesupport_fastrtps_cpp::_BoundingBox3D__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, yolov10_msg, msg, BoundingBox3D)() {
  return &yolov10_msg::msg::typesupport_fastrtps_cpp::_BoundingBox3D__handle;
}
