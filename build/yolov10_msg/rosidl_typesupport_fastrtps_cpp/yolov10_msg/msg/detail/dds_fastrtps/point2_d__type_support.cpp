...
#include "yolov10_msg/msg/detail/point2_d__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const yolov10_msg::msg::Point2D & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  yolov10_msg::msg::Point2D & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = yolov10_msg::msg::Point2D;
    is_plain =
      (
      offsetof(DataType, y) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const yolov10_msg::msg::Point2D *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<yolov10_msg::msg::Point2D *>(
    untyped_ros_message);
...
get_message_type_support_handle<yolov10_msg::msg::Point2D>()
{
  return &yolov10_msg::msg::typesupport_fastrtps_cpp::_Point2D__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, yolov10_msg, msg, Point2D)() {
  return &yolov10_msg::msg::typesupport_fastrtps_cpp::_Point2D__handle;
}
