...
{
  new (message_memory) yolov10_msg::msg::KeyPoint2DArray(_init);
}

void KeyPoint2DArray_fini_function(void * message_memory)
{
  auto typed_message = static_cast<yolov10_msg::msg::KeyPoint2DArray *>(message_memory);
  typed_message->~KeyPoint2DArray();
}

size_t size_function__KeyPoint2DArray__data(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<yolov10_msg::msg::KeyPoint2D> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<yolov10_msg::msg::KeyPoint2D> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<yolov10_msg::msg::KeyPoint2D> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const yolov10_msg::msg::KeyPoint2D *>(
    get_const_function__KeyPoint2DArray__data(untyped_member, index));
  auto & value = *reinterpret_cast<yolov10_msg::msg::KeyPoint2D *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<yolov10_msg::msg::KeyPoint2D *>(
    get_function__KeyPoint2DArray__data(untyped_member, index));
  const auto & value = *reinterpret_cast<const yolov10_msg::msg::KeyPoint2D *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember KeyPoint2DArray_message_member_array[1] = {
  {
    ...
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<yolov10_msg::msg::KeyPoint2D>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(yolov10_msg::msg::KeyPoint2DArray, data),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers KeyPoint2DArray_message_members = {
  ...
  1,  // number of fields
  sizeof(yolov10_msg::msg::KeyPoint2DArray),
...
get_message_type_support_handle<yolov10_msg::msg::KeyPoint2DArray>()
{
  return &::yolov10_msg::msg::rosidl_typesupport_introspection_cpp::KeyPoint2DArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, yolov10_msg, msg, KeyPoint2DArray)() {
  return &::yolov10_msg::msg::rosidl_typesupport_introspection_cpp::KeyPoint2DArray_message_type_support_handle;
}
