...
{
  new (message_memory) yolov10_msg::msg::Mask(_init);
}

void Mask_fini_function(void * message_memory)
{
  auto typed_message = static_cast<yolov10_msg::msg::Mask *>(message_memory);
  typed_message->~Mask();
}

size_t size_function__Mask__data(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<yolov10_msg::msg::Point2D> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<yolov10_msg::msg::Point2D> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<yolov10_msg::msg::Point2D> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const yolov10_msg::msg::Point2D *>(
    get_const_function__Mask__data(untyped_member, index));
  auto & value = *reinterpret_cast<yolov10_msg::msg::Point2D *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<yolov10_msg::msg::Point2D *>(
    get_function__Mask__data(untyped_member, index));
  const auto & value = *reinterpret_cast<const yolov10_msg::msg::Point2D *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Mask_message_member_array[3] = {
  {
    ...
    offsetof(yolov10_msg::msg::Mask, height),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(yolov10_msg::msg::Mask, width),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<yolov10_msg::msg::Point2D>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(yolov10_msg::msg::Mask, data),  // bytes offset in struct
    nullptr,  // default value
...
get_message_type_support_handle<yolov10_msg::msg::Mask>()
{
  return &::yolov10_msg::msg::rosidl_typesupport_introspection_cpp::Mask_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, yolov10_msg, msg, Mask)() {
  return &::yolov10_msg::msg::rosidl_typesupport_introspection_cpp::Mask_message_type_support_handle;
}
