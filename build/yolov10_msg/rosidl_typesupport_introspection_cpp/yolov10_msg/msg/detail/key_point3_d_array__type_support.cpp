...
{
  new (message_memory) yolov10_msg::msg::KeyPoint3DArray(_init);
}

void KeyPoint3DArray_fini_function(void * message_memory)
{
  auto typed_message = static_cast<yolov10_msg::msg::KeyPoint3DArray *>(message_memory);
  typed_message->~KeyPoint3DArray();
}

size_t size_function__KeyPoint3DArray__data(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<yolov10_msg::msg::KeyPoint3D> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<yolov10_msg::msg::KeyPoint3D> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<yolov10_msg::msg::KeyPoint3D> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const yolov10_msg::msg::KeyPoint3D *>(
    get_const_function__KeyPoint3DArray__data(untyped_member, index));
  auto & value = *reinterpret_cast<yolov10_msg::msg::KeyPoint3D *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<yolov10_msg::msg::KeyPoint3D *>(
    get_function__KeyPoint3DArray__data(untyped_member, index));
  const auto & value = *reinterpret_cast<const yolov10_msg::msg::KeyPoint3D *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember KeyPoint3DArray_message_member_array[2] = {
  {
    ...
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<yolov10_msg::msg::KeyPoint3D>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(yolov10_msg::msg::KeyPoint3DArray, data),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(yolov10_msg::msg::KeyPoint3DArray, frame_id),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers KeyPoint3DArray_message_members = {
  ...
  2,  // number of fields
  sizeof(yolov10_msg::msg::KeyPoint3DArray),
...
get_message_type_support_handle<yolov10_msg::msg::KeyPoint3DArray>()
{
  return &::yolov10_msg::msg::rosidl_typesupport_introspection_cpp::KeyPoint3DArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, yolov10_msg, msg, KeyPoint3DArray)() {
  return &::yolov10_msg::msg::rosidl_typesupport_introspection_cpp::KeyPoint3DArray_message_type_support_handle;
}
