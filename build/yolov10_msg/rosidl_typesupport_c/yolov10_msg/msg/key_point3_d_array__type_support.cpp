...
static const _KeyPoint3DArray_type_support_symbol_names_t _KeyPoint3DArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, yolov10_msg, msg, KeyPoint3DArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, yolov10_msg, msg, KeyPoint3DArray)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, yolov10_msg, msg, KeyPoint3DArray)() {
  return &::yolov10_msg::msg::rosidl_typesupport_c::KeyPoint3DArray_message_type_support_handle;
}
