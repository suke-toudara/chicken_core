...
#ifndef YOLOV10_MSG__MSG__DETAIL__KEY_POINT2_D__TRAITS_HPP_
#define YOLOV10_MSG__MSG__DETAIL__KEY_POINT2_D__TRAITS_HPP_
...
inline void to_yaml(
  const yolov10_msg::msg::KeyPoint2D & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const yolov10_msg::msg::KeyPoint2D & msg)
{
  return yolov10_msg::msg::to_yaml(msg);
}

template<>
inline const char * data_type<yolov10_msg::msg::KeyPoint2D>()
{
  return "yolov10_msg::msg::KeyPoint2D";
}

template<>
inline const char * name<yolov10_msg::msg::KeyPoint2D>()
{
  return "yolov10_msg/msg/KeyPoint2D";
}

template<>
struct has_fixed_size<yolov10_msg::msg::KeyPoint2D>
  : std::integral_constant<bool, has_fixed_size<yolov10_msg::msg::Point2D>::value> {};

template<>
struct has_bounded_size<yolov10_msg::msg::KeyPoint2D>
  : std::integral_constant<bool, has_bounded_size<yolov10_msg::msg::Point2D>::value> {};

template<>
struct is_message<yolov10_msg::msg::KeyPoint2D>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // YOLOV10_MSG__MSG__DETAIL__KEY_POINT2_D__TRAITS_HPP_
