...
#ifndef YOLOV10_MSG__MSG__DETAIL__DETECTION__TRAITS_HPP_
#define YOLOV10_MSG__MSG__DETAIL__DETECTION__TRAITS_HPP_
...
// Member 'bbox'
#include "yolov10_msg/msg/detail/bounding_box2_d__traits.hpp"
// Member 'bbox3d'
#include "yolov10_msg/msg/detail/bounding_box3_d__traits.hpp"
// Member 'mask'
#include "yolov10_msg/msg/detail/mask__traits.hpp"
// Member 'keypoints'
#include "yolov10_msg/msg/detail/key_point2_d_array__traits.hpp"
// Member 'keypoints3d'
#include "yolov10_msg/msg/detail/key_point3_d_array__traits.hpp"
...
inline void to_yaml(
  const yolov10_msg::msg::Detection & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const yolov10_msg::msg::Detection & msg)
{
  return yolov10_msg::msg::to_yaml(msg);
}

template<>
inline const char * data_type<yolov10_msg::msg::Detection>()
{
  return "yolov10_msg::msg::Detection";
}

template<>
inline const char * name<yolov10_msg::msg::Detection>()
{
  return "yolov10_msg/msg/Detection";
}

template<>
struct has_fixed_size<yolov10_msg::msg::Detection>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<yolov10_msg::msg::Detection>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<yolov10_msg::msg::Detection>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // YOLOV10_MSG__MSG__DETAIL__DETECTION__TRAITS_HPP_
